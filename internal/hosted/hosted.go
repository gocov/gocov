...
// — in docs/ci-upload.md and in the onboarding page the app renders. They
// are prose and HTML rather than code, so nothing but a test can keep them
// honest: bump this constant on release and TestPinnedCLIVersionIsInSync
// names every file still on the old one.
const PinnedCLIVersion = "v0.12.0"
