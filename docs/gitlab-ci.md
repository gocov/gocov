...
coverage:
  ...
  script:
    ...
    - curl -fsSLO https://github.com/gocov/gocov/releases/download/v0.13.2/gocov-linux-amd64
    - curl -fsSL https://github.com/gocov/gocov/releases/download/v0.13.2/checksums.txt
