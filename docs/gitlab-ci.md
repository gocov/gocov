...
coverage:
  ...
  script:
    - go test ./... -covermode=atomic -coverprofile=coverage.out
    - curl -fsSLO https://github.com/gocov/gocov/releases/download/v0.26.1/gocov-linux-amd64
    - curl -fsSL https://github.com/gocov/gocov/releases/download/v0.26.1/checksums.txt
