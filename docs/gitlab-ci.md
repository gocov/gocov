...
coverage:
  ...
  script:
    ...
    - curl -fsSLO https://github.com/gocov/gocov/releases/download/v0.18.0/gocov-linux-amd64
    - curl -fsSL https://github.com/gocov/gocov/releases/download/v0.18.0/checksums.txt
